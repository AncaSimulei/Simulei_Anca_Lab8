...
namespace Simulei_Anca_Lab8.Models
{
    public class BookCategoriesPageModel:PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Simulei_Anca_Lab8Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Simulei_Anca_Lab8Context context,
